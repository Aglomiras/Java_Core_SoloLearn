...
public class Lecture_18 {
     ...
     *
     * Пример работы synchronized рассмотрен в Practic_2
     *
     *
     ...
     *
     *
     * Зачем нужны synchronized методы для чтения?
     * Помимо атомарности, у synchronized есть ещё одна задача - обеспечить видимость изменений.
     * Обратимся к примеру в Practic_3/
     *
     * */
}
